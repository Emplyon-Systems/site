            ...
            {items.map((item, index) => (
                <div
                    ...
                    className={cn(
                        ...
                        "border border-white/10 bg-deep-navy",
                ...
                >
                    ...
                    <div className="relative flex flex-col space-y-3 h-full">
                        ...
                        <div className="space-y-2 flex-1">
                            <h3 className="font-medium text-pure-white tracking-tight text-[15px]">
                                {item.title}
                                <span className="ml-2 text-xs text-pure-white font-normal">
                                    {item.meta}
                                </span>
                            </h3>
                            <p className="text-sm text-pure-white leading-snug font-[425]">
                                {item.description}
                            </p>
                        </div>

                        <div className="flex items-center justify-center mt-2">
                            <div className="flex items-center space-x-2 text-xs text-pure-white">
                                {item.tags?.map((tag, i) => (
                                    <span
                                        key={i}
