...
const faqs = [
    {
        ...
        answer: "Sim! Oferecemos um período de teste gratuito de 14 dias com acesso a todas as funcionalidades do plano Professional, sem necessidade de cartão de crédito.",
        meta: "Teste Grátis",
    },
    {
        question: "É possível integrar com outros softwares?",
        answer: <>Com certeza. <span className='notranslate' translate='no'>A Emplyon</span> integra nativamente com mais de 50 ferramentas populares (Slack, Salesforce, HubSpot) e possui uma API aberta para integrações customizadas.</>,
        meta: "Integrações",
    },
    {
        question: "Como funciona o suporte?",
        answer: "Nosso suporte funciona 24/7. Clientes do plano Starter têm resposta em até 24h, enquanto planos Professional e Enterprise possuem atendimento prioritário em tempo real.",
        meta: "Suporte",
    },
    {
        question: "Qual o período mínimo de contrato?",
        answer: "Nossos contratos possuem uma fidelidade mínima de 6 meses para garantir a estabilidade da operação e o retorno sobre o investimento. Após esse período, o cancelamento pode ser feito sem multas.",
        meta: "Contrato",
    },
];
...
const palettes = {
    dark: {
        ...
        panel: "bg-royal-blue text-white",
        border: "border-royal-blue/20",
        heading: "text-white", // Inside cards
        sectionHeading: "text-deep-navy", // Outside cards
        muted: "text-white/80", // Inside cards
        sectionMuted: "text-neutral-600", // Outside cards
        iconRing: "border-white/20",
        iconSurface: "bg-white/10",
        icon: "text-white",
        toggle: "hidden",
        toggleSurface: "hidden",
        glow: "rgba(255, 255, 255, 0.1)",
        aurora: "transparent",
        shadow: "shadow-[0_20px_50px_rgba(1,121,254,0.15)]",
        overlay: "transparent",
    },
    light: {
        surface: "bg-white text-neutral-900",
        ...
        border: "border-royal-blue/20",
        heading: "text-white",
        sectionHeading: "text-deep-navy",
        muted: "text-white/80",
        sectionMuted: "text-neutral-600",
        iconRing: "border-white/20",
        iconSurface: "bg-white/10",
        icon: "text-white",
        toggle: "hidden",
...
function FAQMonochrome() {
    ...
    return (
        <div id="faq" className={`relative min-h-screen w-full overflow-hidden transition-colors duration-700 ${palette.surface}`}>
            ...
            >
                <div
                    className={`faq1-intro ${introReady ? "faq1-intro--active" : ""} ${theme === "light" ? "faq1-intro--light" : "faq1-intro--dark"
                        }`}
                >
                    <span className="faq1-intro__beam" aria-hidden="true" />
                    <span className="faq1-intro__pulse" aria-hidden="true" />
                    <span className="faq1-intro__label">Dúvidas</span>
                ...
                <header className="flex flex-col gap-8 md:flex-row md:items-end md:justify-between">
                    <div className="space-y-4">
                        <p className={`text-xs uppercase tracking-[0.35em] ${palette.sectionMuted}`}>FAQ</p>
                        <h1 className={`text-4xl font-semibold leading-tight md:text-5xl ${palette.sectionHeading}`}>
                            Perguntas Frequentes
                        </h1>
                        <p className={`max-w-xl text-base ${palette.sectionMuted}`}>
                            Tudo o que você precisa saber sobre a nossa plataforma, condensado com clareza e precisão.
                        </p>
                    </div>
                </header>
                ...
                <ul className="space-y-4">
                    {faqs.map((item, index) => {
                        ...
                        return (
                            <li
                                key={item.question}
                                className={`group relative overflow-hidden rounded-2xl border backdrop-blur-xl transition-all duration-500 hover:-translate-y-0.5 focus-within:-translate-y-0.5 ${palette.border} ${palette.panel} ${palette.shadow}`}
                            ...
                            >
                                ...
                                <button
                                    ...
                                    className="relative flex w-full flex-col gap-3 px-6 py-5 text-left transition-colors duration-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[var(--faq-outline)]"
                                >
                                    ...
                                    <div
                                        ...
                                        className={`overflow-hidden text-sm leading-relaxed transition-[max-height] duration-500 ease-out pl-0 md:pl-[3.5rem] ${open ? "max-h-64" : "max-h-0"
                                            } ${palette.muted}`}
                                    >
                                        <p className="pr-2">
                                            {item.answer}
